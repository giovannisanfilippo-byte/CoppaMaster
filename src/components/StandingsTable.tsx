          ...
          <tbody className="divide-y divide-slate-100">
            {standings.map((s, i) => (
              <tr key={s.name} className="hover:bg-slate-50/50">
                <td className="px-3 py-2 font-black text-slate-300">{i + 1}</td>
                ...
                <td className="px-3 py-2 text-center font-black text-indigo-600">{s.pts}</td>
                <td className="px-3 py-2 text-center font-medium">{s.p}</td>
                <td className="px-3 py-2 text-center font-medium text-emerald-600">{s.w}</td>
                <td className="px-3 py-2 text-center font-medium text-slate-400">{s.d}</td>
                <td className="px-3 py-2 text-center font-medium text-red-400">{s.l}</td>
                <td className="px-3 py-2 text-center font-medium">{s.gf}</td>
                <td className="px-3 py-2 text-center font-medium">{s.ga}</td>
                <td className="px-3 py-2 text-center font-medium text-slate-400">{s.gf - s.ga}</td>
              </tr>
            ))}
            {standings.length === 0 && (
              <tr>
